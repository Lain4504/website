...
const OurPolicy = () => {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-4 sm:grid-cols-2 xs:grid-cols-2 gap-12 sm:gap-4 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700'>
      <div>

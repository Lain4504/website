...
const TermsOfService = () => {
  ...
  return (
    ...
    <div className="p-6 bg-white rounded-lg shadow-lg">
      ...
      <Paragraph className="text-lg font-bold text-gray-900">Chào mừng Quý khách đến mua sắm tại Forever.VN</Paragraph>
      <Paragraph className="text-gray-700">
        Sau khi truy cập vào website Forever để tham khảo hoặc mua sắm, Quý khách đã đồng ý tuân thủ và ràng buộc với những
        quy định của Forever. Trang web có quyền thay đổi, chỉnh sửa, thêm hoặc lược bỏ bất kỳ phần nào trong Điều khoản mua
      ...
      <Paragraph className="text-gray-700">
        Khi mua sắm tại Forever.VN, Quý khách sẽ cung cấp cho chúng tôi thông tin về địa chỉ email, mật khẩu và họ tên để
      ...
      <Paragraph className="text-gray-700">
        Khi mua sắm tại website Forever.VN, Quý khách được đảm bảo rằng những thông tin cung cấp cho chúng tôi sẽ chỉ được
        dùng để nâng cao chất lượng dịch vụ dành cho khách hàng của Forever và sẽ không được chuyển giao cho 1 bên thứ ba nào
      ...
      <Paragraph className="text-gray-700">
        ...
        thống hay làm thay đổi cấu trúc dữ liệu tại website Forever.
      </Paragraph>

      <Divider />

      <Paragraph className="text-lg font-bold text-gray-900">4. Trách nhiệm và quyền lợi của Forever</Paragraph>
      <Paragraph className="text-gray-700">
        Trong trường hợp có những phát sinh ngoài ý muốn hoặc trách nhiệm của mình, Forever sẽ không chịu trách nhiệm về mọi
        tổn thất phát sinh. Ngoài ra, chúng tôi không cho phép các tổ chức, cá nhân khác quảng bá sản phẩm tại website Forever
